                ...
                <div class="flex-1 overflow-y-auto p-6">
                    <form :action="formAction" method="POST" id="userForm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-1">Password <span x-show="!isEdit">*</span></label>
                                <input type="password" name="password" :required="!isEdit" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-gold focus:border-transparent @error('password') border-red-500 @enderror" placeholder="Leave blank to keep current password" x-bind:placeholder="isEdit ? 'Leave blank to keep current' : 'Enter password'">
