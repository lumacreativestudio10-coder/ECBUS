                    ...
                    <form :action="formAction" method="POST" id="userForm">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="password" name="password" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-gold focus:border-transparent @error('password') border-red-500 @enderror" placeholder="Leave blank to auto-generate (or keep current if editing)">
